...
//creates objects	ain array of [child,parent] pairs
  var node = "2"; //FOR DEMO
	pairAssembler(node);
//creates elements
  elements();
...
function setCamera(){
  var ocam=new THREE.OrthographicCamera(w/-2,w/2,h/2,h/-2,0.1,1000);
  var pcam=new THREE.PerspectiveCamera(75,w/h,0.1,1000);
